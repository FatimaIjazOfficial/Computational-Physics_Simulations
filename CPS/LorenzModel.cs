...
namespace CPS
{
    public class LorenzModel
    {
        ...
        public void PlotYvsX(Form form) => Plot(form, Color.AliceBlue, (t, x, y, z) => (x, y), 1.0, 0.0, 0.0);
        ...
        public void PlotYvsZ(Form form) => Plot(form, Color.Tomato, (t, x, y, z) => (z, y), 0.0, 1.0, 0.0);
